...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem!", "Vou para São Paulo, beijos.", new AuthorDTO(maria));
        ...
        CommentDTO comment3 = new CommentDTO("Tenha um bom dia!", sdf.parse("23/03/2018"), new AuthorDTO(alex));
